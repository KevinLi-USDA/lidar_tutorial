...
# now you can run one of the above processes, like identify ground:

ctg_gnd <- classify_ground(ctg, algorithm = pmf(ws = 15, th = 9))
...
# run your favorite lidR process in parallel on the LAScatalog! e.g.:
ctg_gnd <- classify_ground(ctg, algorithm = pmf(ws = 15, th = 9))
